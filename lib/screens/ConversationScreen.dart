            ...
            gradient: LinearGradient(
              colors: sendByMe ? [
                ...
                const Color(0xff2A75BC)
                  ...
                  : [
                const Color(0xCD908D8D),
                const Color(0xADA8A4A4)
              ],
            )
        ),
        child: Text(message,
...
class _ConversationScreenState extends State<ConversationScreen>{
  ...
  void initState() {
    setState(() {
      msgs.add({
        "message": "Hi! Hasbulla here",
        "sendByMe": false
      });
      msgs.add({
        "message": "I need some urgent money",
        "sendByMe": false
      });
    });
    super.initState();
        ...
        child:
          Stack(
            children: [
              ...
              messageList(this.msgs),
              messageBox(Colors.white, messageController),
            ],
          )
      ),
    );
